...
export class DotLottiePlayerWasm {
    ...
    layout_fit() {
        ...
        try {
            ...
            wasm.dotlottieplayerwasm_layout_fit(retptr, this.__wbg_ptr);
     ...
     */
    reset_node(target) {
        const ptr0 = passStringToWasm0(target, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.dotlottieplayerwasm_reset_node(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
    ...
    set_layout(fit, align_x, align_y) {
        const ptr0 = passStringToWasm0(fit, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len0 = WASM_VECTOR_LEN;
    ...
    remove_node(name) {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.dotlottieplayerwasm_remove_node(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    reset_nodes() {
        const ret = wasm.dotlottieplayerwasm_reset_nodes(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    ...
    animation_id() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dotlottieplayerwasm_animation_id(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            let v1;
            if (r0 !== 0) {
    ...
    get_slot_str(id) {
        try {
            ...
            const ptr0 = passStringToWasm0(id, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
            wasm.dotlottieplayerwasm_get_slot_str(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            let v2;
            if (r0 !== 0) {
     ...
     * @returns {number}
     */
    animate_value(from, to, options) {
        try {
            const ret = wasm.dotlottieplayerwasm_animate_value(this.__wbg_ptr, from, to, addBorrowedObject(options));
            return ret;
        } finally {
    ...
    get_slot_type(id) {
        try {
            ...
            const ptr0 = passStringToWasm0(id, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
            wasm.dotlottieplayerwasm_get_slot_type(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            let v2;
            if (r0 !== 0) {
    ...
    get_slots_str() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dotlottieplayerwasm_get_slots_str(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
     ...
     */
    motion_active() {
        const ret = wasm.dotlottieplayerwasm_motion_active(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {number}
    ...
    set_text_slot(id, text) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(text, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len1 = WASM_VECTOR_LEN;
     ...
     */
    set_transform(data) {
        const ptr0 = passArrayF32ToWasm0(data, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
     ...
     */
    animation_stop(id) {
        wasm.dotlottieplayerwasm_animation_stop(this.__wbg_ptr, id);
    }
    /**
    ...
    current_marker() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dotlottieplayerwasm_current_marker(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            let v1;
            if (r0 !== 0) {
     ...
     * @returns {boolean}
     */
    duplicate_node(source, as_name) {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(as_name, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.dotlottieplayerwasm_duplicate_node(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return ret !== 0;
    }
    /**
     * @returns {number}
    ...
    set_image_slot(id, src) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(src, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len1 = WASM_VECTOR_LEN;
     ...
     */
    animation_pause(id) {
        wasm.dotlottieplayerwasm_animation_pause(this.__wbg_ptr, id);
    }
    /**
     * @param {number} id
     * @returns {number}
     */
    animation_value(id) {
        const ret = wasm.dotlottieplayerwasm_animation_value(this.__wbg_ptr, id);
        return ret;
    }
    /**
    ...
    manifest_string() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dotlottieplayerwasm_manifest_string(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
     ...
     * @returns {boolean}
     */
    setup_wg_target(width, height) {
        const ret = wasm.dotlottieplayerwasm_setup_wg_target(this.__wbg_ptr, width, height);
        return ret !== 0;
    }
    /**
     * @param {number} id
     */
    animation_cancel(id) {
        wasm.dotlottieplayerwasm_animation_cancel(this.__wbg_ptr, id);
    }
    /**
     * @param {number} id
     */
    animation_resume(id) {
        wasm.dotlottieplayerwasm_animation_resume(this.__wbg_ptr, id);
    }
    /**
    ...
    sm_current_state() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dotlottieplayerwasm_sm_current_state(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    state_machine_id() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dotlottieplayerwasm_state_machine_id(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            let v1;
            if (r0 !== 0) {
    ...
    get_state_machine(id) {
        try {
            ...
            const ptr0 = passStringToWasm0(id, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
            wasm.dotlottieplayerwasm_get_state_machine(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            let v2;
            if (r0 !== 0) {
    ...
    set_webgpu_device(device) {
        wasm.dotlottieplayerwasm_set_webgpu_device(this.__wbg_ptr, addHeapObject(device));
    }
    /**
     * @returns {number}
     */
    ...
    set_webgpu_surface(surface) {
        wasm.dotlottieplayerwasm_set_webgpu_surface(this.__wbg_ptr, addHeapObject(surface));
    }
    /**
    ...
    state_machine_load(definition) {
        const ptr0 = passStringToWasm0(definition, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len0 = WASM_VECTOR_LEN;
     ...
     * @param {number} speed
     */
    animation_set_speed(id, speed) {
        wasm.dotlottieplayerwasm_animation_set_speed(this.__wbg_ptr, id, speed);
    }
    /**
    ...
    sm_get_string_input(key) {
        try {
            ...
            const ptr0 = passStringToWasm0(key, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
            wasm.dotlottieplayerwasm_sm_get_string_input(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            let v2;
            if (r0 !== 0) {
    ...
    sm_override_current_state(state, immediate) {
        const ptr0 = passStringToWasm0(state, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len0 = WASM_VECTOR_LEN;
    ...
    layers() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dotlottieplayerwasm_layers(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    ...
    animate(target, keyframes, options) {
        try {
            const ptr0 = passStringToWasm0(target, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.dotlottieplayerwasm_animate(this.__wbg_ptr, ptr0, len0, addBorrowedObject(keyframes), addBorrowedObject(options));
            return ret;
        } finally {
            heap[stack_pointer++] = undefined;
            heap[stack_pointer++] = undefined;
     ...
     */
    sm_fire(event) {
        const ptr0 = passStringToWasm0(event, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len0 = WASM_VECTOR_LEN;
    ...
    get_node(target) {
        const ptr0 = passStringToWasm0(target, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.dotlottieplayerwasm_get_node(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
     * @param {boolean} v
     ...
     * @returns {boolean}
     */
    set_node(target, props) {
        try {
            const ptr0 = passStringToWasm0(target, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.dotlottieplayerwasm_set_node(this.__wbg_ptr, ptr0, len0, addBorrowedObject(props));
            return ret !== 0;
        } finally {
            heap[stack_pointer++] = undefined;
        }
    ...
    sm_start(require_user_interaction, whitelist) {
        const ptr0 = passArrayJsValueToWasm0(whitelist, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
    ...
    theme_id() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dotlottieplayerwasm_theme_id(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            let v1;
            if (r0 !== 0) {
    ...
    sm_status() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dotlottieplayerwasm_sm_status(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_setconstants_08df997e38e4da58 = function(arg0, arg1) {
        getObject(arg0).constants = getObject(arg1);
    };
    ...
    imports.wbg.__wbg_setdepthslice_4c2d15e75ec01602 = function(arg0, arg1) {
        getObject(arg0).depthSlice = arg1 >>> 0;
    };
    ...
    imports.wbg.__wbg_writeBuffer_b5be14e621130604 = function() { return handleError(function (arg0, arg1, arg2, arg3) {
        getObject(arg0).writeBuffer(getObject(arg1), arg2, getObject(arg3));
    }, arguments) };
