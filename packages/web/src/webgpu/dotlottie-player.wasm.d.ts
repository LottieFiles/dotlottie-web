...
export const dotlottieplayerwasm_set_webgpu_device: (a: number, b: number) => void;
export const dotlottieplayerwasm_set_webgpu_surface: (a: number, b: number) => void;
export const dotlottieplayerwasm_setup_wg_target: (a: number, b: number, c: number) => number;
...
export const wgpuSurfaceCapabilitiesFreeMembers: (a: number) => void;
export const wgpuSurfaceConfigure: (a: number, b: number) => void;
export const wgpuSurfaceGetCapabilities: (a: number, b: number, c: number) => number;
