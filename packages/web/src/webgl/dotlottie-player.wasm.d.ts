...
export const _ZNSt3__25mutex4lockEv: (a: number) => void;
export const _ZNSt3__25mutexD1Ev: (a: number) => number;
...
export const acoshf: (a: number) => number;
export const asinh: (a: number) => number;
export const asinhf: (a: number) => number;
export const atanh: (a: number) => number;
export const atanhf: (a: number) => number;
export const bsearch: (a: number, b: number, c: number, d: number, e: number) => number;
export const dotlottieplayerwasm_animate: (a: number, b: number, c: number, d: number, e: number) => number;
export const dotlottieplayerwasm_animate_value: (a: number, b: number, c: number, d: number) => number;
export const dotlottieplayerwasm_animation_cancel: (a: number, b: number) => void;
export const dotlottieplayerwasm_animation_id: (a: number, b: number) => void;
export const dotlottieplayerwasm_animation_pause: (a: number, b: number) => void;
export const dotlottieplayerwasm_animation_resume: (a: number, b: number) => void;
export const dotlottieplayerwasm_animation_set_speed: (a: number, b: number, c: number) => void;
export const dotlottieplayerwasm_animation_size: (a: number) => number;
export const dotlottieplayerwasm_animation_stop: (a: number, b: number) => void;
export const dotlottieplayerwasm_animation_value: (a: number, b: number) => number;
...
export const dotlottieplayerwasm_current_marker: (a: number, b: number) => void;
export const dotlottieplayerwasm_duplicate_node: (a: number, b: number, c: number, d: number, e: number) => number;
export const dotlottieplayerwasm_duration: (a: number) => number;
export const dotlottieplayerwasm_emit_on_loop: (a: number) => void;
export const dotlottieplayerwasm_get_node: (a: number, b: number, c: number) => number;
export const dotlottieplayerwasm_get_slot_ids: (a: number) => number;
export const dotlottieplayerwasm_get_slot_str: (a: number, b: number, c: number, d: number) => void;
export const dotlottieplayerwasm_get_slot_type: (a: number, b: number, c: number, d: number) => void;
export const dotlottieplayerwasm_get_slots_str: (a: number, b: number) => void;
export const dotlottieplayerwasm_get_state_machine: (a: number, b: number, c: number, d: number) => void;
export const dotlottieplayerwasm_get_transform: (a: number) => number;
export const dotlottieplayerwasm_height: (a: number) => number;
export const dotlottieplayerwasm_is_complete: (a: number) => number;
export const dotlottieplayerwasm_layers: (a: number, b: number) => void;
...
export const dotlottieplayerwasm_layout_fit: (a: number, b: number) => void;
...
export const dotlottieplayerwasm_manifest_string: (a: number, b: number) => void;
export const dotlottieplayerwasm_marker_names: (a: number) => number;
export const dotlottieplayerwasm_markers: (a: number) => number;
export const dotlottieplayerwasm_mode: (a: number) => number;
export const dotlottieplayerwasm_motion_active: (a: number) => number;
...
export const dotlottieplayerwasm_poll_event: (a: number) => number;
export const dotlottieplayerwasm_remove_node: (a: number, b: number, c: number) => number;
...
export const dotlottieplayerwasm_reset_node: (a: number, b: number, c: number) => number;
export const dotlottieplayerwasm_reset_nodes: (a: number) => number;
...
export const dotlottieplayerwasm_set_node: (a: number, b: number, c: number, d: number) => number;
...
export const dotlottieplayerwasm_set_webgl_context: (a: number, b: number) => void;
export const dotlottieplayerwasm_setup_gl_target: (a: number, b: number, c: number) => number;
export const dotlottieplayerwasm_sm_current_state: (a: number, b: number) => void;
export const dotlottieplayerwasm_sm_fire: (a: number, b: number, c: number) => number;
export const dotlottieplayerwasm_sm_framework_setup: (a: number) => number;
export const dotlottieplayerwasm_sm_get_boolean_input: (a: number, b: number, c: number) => number;
export const dotlottieplayerwasm_sm_get_inputs: (a: number) => number;
export const dotlottieplayerwasm_sm_get_numeric_input: (a: number, b: number, c: number) => number;
export const dotlottieplayerwasm_sm_get_string_input: (a: number, b: number, c: number, d: number) => void;
export const dotlottieplayerwasm_sm_override_current_state: (a: number, b: number, c: number, d: number) => number;
export const dotlottieplayerwasm_sm_poll_event: (a: number) => number;
export const dotlottieplayerwasm_sm_poll_internal_event: (a: number) => number;
...
export const dotlottieplayerwasm_sm_status: (a: number, b: number) => void;
export const dotlottieplayerwasm_sm_stop: (a: number) => number;
export const dotlottieplayerwasm_sm_tick: (a: number, b: number) => number;
export const dotlottieplayerwasm_speed: (a: number) => number;
export const dotlottieplayerwasm_state_machine_id: (a: number, b: number) => void;
...
export const dotlottieplayerwasm_status: (a: number) => number;
export const dotlottieplayerwasm_stop: (a: number) => number;
export const dotlottieplayerwasm_theme_id: (a: number, b: number) => void;
export const dotlottieplayerwasm_tick: (a: number, b: number) => number;
...
export const glDrawArrays: (a: number, b: number, c: number) => void;
...
export const nextafter: (a: number, b: number) => number;
...
export const tinyrlibc_itoa: (a: bigint, b: number, c: number, d: number) => number;
export const tinyrlibc_utoa: (a: bigint, b: number, c: number, d: number) => number;
export const tinyrlibc_rand_r: (a: number) => number;
export const tinyrlibc_strtoul: (a: number, b: number, c: number) => number;
export const _ZNSt3__25mutex6unlockEv: (a: number) => void;
export const _ZdlPvm: (a: number, b: number) => void;
export const __cxa_thread_atexit: (a: number, b: number, c: number) => number;
