...
export const dlMediaClose: (a: number) => void;
export const dlMediaOpen: (a: number, b: number) => number;
export const dlMediaSeek: (a: number, b: number) => void;
export const dlMediaSetMute: (a: number, b: number) => void;
export const dlMediaSetPlaying: (a: number, b: number) => void;
export const dlMediaSetVolume: (a: number, b: number) => void;
export const dlMediaSync: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
...
export const dotlottieplayerwasm_set_asset_resolver: (a: number, b: number) => void;
