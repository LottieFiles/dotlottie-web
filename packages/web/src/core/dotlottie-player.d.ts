...
export class DotLottiePlayerWasm {
   ...
   */
  set_asset_resolver(resolver?: Function | null): void;
  /**
...
export interface InitOutput {
  ...
  readonly dotlottieplayerwasm_get_pixel_buffer: (a: number) => number;
  ...
  readonly dotlottieplayerwasm_set_asset_resolver: (a: number, b: number) => void;
  ...
  readonly dotlottieplayerwasm_setup_sw_target: (a: number, b: number, c: number) => number;
