...
export const Perf = (): JSX.Element => {
  ...
  return (
    <div className="pt-4 pb-24 bg-gray-900 sm:pb-32 sm:pt-8">
      <div className="px-6 mx-auto max-w-7xl lg:px-8">
        ...
        <ul className="grid mt-20 gap-x-8 gap-y-14 sm:grid-cols-4 xl:grid-cols-5">
...
const Dropdown = ({ label, options, selected, onChange }: DropdownProps) => (
  <div className="relative">
    ...
    <div
      className="absolute right-0 z-10 hidden w-full mt-2 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5"
      id={`${label}-menu`}
    >
      <div className="py-1">
        {options.map((option) => (
