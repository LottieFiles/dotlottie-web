...
function ThemeToggle(): JSX.Element {
  ...
  return (
    <button
      onClick={cycleTheme}
      className="p-2 transition-colors border rounded-lg bg-subtle dark:bg-dark-surface border-subtle dark:border-dark-border text-primary dark:text-dark-text hover:bg-strong dark:hover:bg-dark-border"
      title={getTitle()}
      aria-label={getTitle()}
    >
      {getIcon()}
...
function PlaygroundContent(): JSX.Element {
  ...
  return (
    <div className="flex flex-col h-screen bg-white dark:bg-dark-bg">
      {/* Header */}
      <header className="flex items-center justify-between px-4 py-3 border-b bg-subtle dark:bg-dark-surface border-subtle dark:border-dark-border">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={handleRun}
            className="px-4 py-2 font-bold text-white transition-colors rounded-lg bg-lottie hover:bg-lottie/80"
          ...
          <button
            onClick={handleShare}
            className="px-4 py-2 font-bold transition-colors border rounded-lg bg-subtle dark:bg-dark-surface border-subtle dark:border-dark-border text-primary dark:text-dark-text hover:bg-strong dark:hover:bg-dark-border"
          >
            Share
          </button>
          <button
