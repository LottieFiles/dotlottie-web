          ...
          <div className="flex h-screen gap-4 p-4" {...state.getRootProps()}>
            ...
            <div className="flex flex-col flex-grow gap-4">
              <div className="flex items-center gap-2">
                ...
                <Link to="/playground" className="p-2 font-bold rounded-lg bg-subtle hover:bg-hover whitespace-nowrap">
                  Playground
                </Link>
                <Link to="/perf-test" className="p-2 font-bold rounded-lg bg-subtle hover:bg-hover whitespace-nowrap">
                  Performance
                </Link>
                <a
                  ...
                  className="p-2 font-bold rounded-lg bg-subtle hover:bg-hover whitespace-nowrap"
                >
                  Docs
                </a>
              </div>
